...
[![Release](https://api.omegazero.org/v1/git/getrepobadge?author=sxboot&repository=core&metric=release&color=0aa&width=100)](https://git.omegazero.org/sxboot/core/releases)
